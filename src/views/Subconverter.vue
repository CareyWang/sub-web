  ...
  data() {
    return {
      ...
      options: {
        ...
        backendOptions: [{ value: "https://sub.innoais.com/sub?" }],
        remoteConfig: [
                  {
                      label: "自定义",
                      options: [
                          {
                              label: "ACL4SSR_自定义_Full_Spotify",
                              value: "https://raw.githubusercontent.com/pol117/acl4ssr-config/refs/heads/main/Happy_Web.ini",
                          },
                      ],
                  },
                  {
